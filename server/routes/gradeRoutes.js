...
const { getGrades, createGrade, updateGrade, getOneGrade } = require('../controllers/gradeController')
...
router.route("/")
    .get(verifyToken(true), secureGetAll({ key: "isActive", value: true }, [user_roles.SUBADMIN]), getGrades)
...
// .delete(verifyToken(), allowedTo(user_roles.ADMIN), deleteFeedBack)
