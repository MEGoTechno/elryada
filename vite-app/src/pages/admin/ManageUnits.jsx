...
import { unitsPerms } from '../../components/permissions/constants/courses'
    ...
    return (
        <>
            <FlexBetween gap={'10px'} m={'20px 0'}>
                <FlexRow gap={'4px'}>
                    {hasPermission(unitsPerms(null, 'delete')) && (
                        <IconButton
                            sx={{
                                bgcolor: red[500],
                                '&:hover': {
                    ...
                    {hasPermission(unitsPerms(null, 'update')) && (
                        <IconButton
                            sx={{
                                bgcolor: orange[500],
                                '&:hover': {
                ...
                {hasPermission(unitsPerms(null, 'create')) && (
