    ...
    return (
        <Section sx={{  bgcolor: "rgb(18, 20, 27)" }}>
            <FlexColumn gap={'12px'}>
                ...
                <Typography component={Link} to={"https://api.whatsapp.com/send?phone=2001001902943&text=" + 'from Elryada Platform'} variant='body2' sx={{ color: "grey.0", textDecoration: 'none' }} noWrap>
