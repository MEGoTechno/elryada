...
import AdminCourseTeachers from './AdminCourseTeachers'
            ...
            <>
                ...
                <FlexColumn>
                    ...
                    <FlexRow gap={'12px'} width={"100%"}>
                        {hasPermission(coursesPerms(course._id, 'subscriptions')) && (
                            <>
                        ...
                        {hasPermission(coursesPerms(course._id, 'teachers'), coursesPerms(course._id, 'permissions')) && (
                            <AdminCourseTeachers course={course} />
                        )}
                        {/* Error Here ######################################### */}

                        {hasPermission(coursesPerms(course._id, 'coupons')) && (
                            <BtnModal
                        ...
                        {hasPermission(coursesPerms(course._id, 'delete')) && (
                    ...
                    <FlexColumn gap={'8px'}>
                        ...
                        <CourseUpdate course={course} setCourse={setCourse} setCourses={setCourses} isAllDisabled={!hasPermission(coursesPerms(course._id, 'update'))} />
                    </FlexColumn>

                </FlexColumn>
                {/* {hasPermission(coursesPerms(course._id, 'joinCourses')) && (
